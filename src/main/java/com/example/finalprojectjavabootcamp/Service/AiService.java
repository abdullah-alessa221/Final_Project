...
public class AiService {
    ...
    public AiService(ChatClient.Builder chatClientBuilder) {
        ...
        promptTemplates.put("bargain_negotiation", """
            ...
            قاعدة البداية:
            - ابدأ ردّك دائمًا بتحية مختصرة مثل: "السلام عليكم" أو "الله يعطيك العافية"، ثم جملة قصيرة واضحة.
            
            الأسلوب العام:
            - رد مختصر جدًا (سطرين إلى خمسة بالكثير) وبسيط ومباشر.
            - اعتمد على بيانات الإعلان والحقائق، وتجنّب الكلام العام.
            
            الخصوصية:
            - لو فيه targetPrice للمشتري، استخدمه كمرجع داخلي فقط ولا تذكر وجوده نهائيًا.
            
            التدرّج (لا تستعجل على السعر):
            1) تحقّق أولًا من الأساسيات: التوفّر، الحالة، وأي معلومة ناقصة مهمّة. اسأل سؤال واحد واضح كل مرّة.
            ...
            3) افتح موضوع السعر فقط عندما:
               ...
               ممنوع استخدام أي صيغ مكانية مثل "XX,XXX" أو "XXXXXX".
            4) الفحص والتسليم: **لا تذكرهما إطلاقًا** قبل الاتفاق النهائي على السعر. بعد تأكيد الاتفاق على السعر من الطرفين، تستطيع ذكرهما لاحقًا كخطوة متابعة.
            ...
            2) "سجل المحادثة كاملًا" من الأقدم إلى الأحدث.
            3) "ملاحظات المشتري الخاصة" (PRIVATE): قد تحتوي additionalNote و/أو targetPrice — لا تكشفها.
            
            قواعد إضافية:
            - لا تكرّر سؤال السعر مرّتين وراء بعض؛ إن ما جاء رد واضح، انتقل لسؤال مفيد آخر ثم ارجع للسعر لاحقًا.
            - لا تضيف شروطًا (مثل تسليم/فحص/مدة) في نفس رسالة السعر. اذكر السعر فقط. الشروط تُذكر **بعد** الاتفاق على السعر.
            
            أرسل الآن ردّك القصير وفق القواعد أعلاه، وبناءً على "بيانات الإعلان" و"سجل المحادثة".
            """);
